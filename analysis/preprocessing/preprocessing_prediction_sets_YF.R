# R script to engineer Yellow Fever expression data into gene-set level features
...
p_save_sequential_list_yellowfeverlv_withTBA <- fs::path(processed_data_folder, "sequential_list_yellowfeverlv_withTBA.rds")
p_save_cumulative_list_yellowfeverlv_withTBA <- fs::path(processed_data_folder, "cumulative_list_yellowfeverlv_withTBA.rds")

# Save the data
saveRDS(sequential_list, p_save_sequential_list_yellowfeverlv_withTBA)
saveRDS(cumulative_list, p_save_cumulative_list_yellowfeverlv_withTBA)
...
# Specify the path to save the lists
p_save_sequential_list_yellowfeverlv_withoutTBA <- fs::path(processed_data_folder, "sequential_list_yellowfeverlv_withoutTBA.rds")
p_save_cumulative_list_yellowfeverlv_withoutTBA <- fs::path(processed_data_folder, "cumulative_list_yellowfeverlv_withoutTBA.rds")

# Save the data
saveRDS(sequential_list, p_save_sequential_list_yellowfeverlv_withoutTBA)
saveRDS(cumulative_list, p_save_cumulative_list_yellowfeverlv_withoutTBA)