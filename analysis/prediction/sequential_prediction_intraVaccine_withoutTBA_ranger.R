...
prediction_results_all_sequential_withClinical_withoutTBA_ranger <- vector("list", length(sequential_prediction_sets_withoutTBA))
names(prediction_results_all_sequential_withClinical_withoutTBA_ranger) <- names(sequential_prediction_sets_withoutTBA)
...
for (vac in names(sequential_prediction_sets_withoutTBA)) {
  ...
  prediction_results_all_sequential_withClinical_withoutTBA_ranger[[vac]] <- vector("list", length(set_names))
  names(prediction_results_all_sequential_withClinical_withoutTBA_ranger[[vac]]) <- set_names
  ...
  for (set_name in set_names) {
    ...
    # store the result
    prediction_results_all_sequential_withClinical_withoutTBA_ranger[[vac]][[set_name]] <- res
...
# Save these results
p_prediction_results_all_sequential_withClinical_withoutTBA_ranger = fs::path(
  "output",
  "results",
  "prediction",
...
saveRDS(prediction_results_all_sequential_withClinical_withoutTBA_ranger,
        file = p_prediction_results_all_sequential_withClinical_withoutTBA_ranger)
...
prediction_results_all_sequential_withClinical_withoutTBA_ranger = readRDS(p_prediction_results_all_sequential_withClinical_withoutTBA_ranger)

# --- 1. Build vaccine x set grid and extract Rspearman + sRMSE in one pass ----
vaccines <- names(prediction_results_all_sequential_withClinical_withoutTBA_ranger)
...
for (i in seq_len(n)) {
  ...
  if (is.null(prediction_results_all_sequential_withClinical_withoutTBA_ranger[[vac]]))
    next
  res_set <- prediction_results_all_sequential_withClinical_withoutTBA_ranger[[vac]][[setn]]
...
# --- Save figure ---
ggsave(
  filename = "evaluation_combined_sequential_withClinical_withoutTBA_ranger.pdf",
...
# --- Save figure ---
ggsave(
  filename = "evaluation_combined_sequential_withoutClinical_withoutTBA_ranger.pdf",
  path = prediction_figures_folder,
  plot = combined,
  width = 40,
  height = 25,
